...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "quadcoin.conf"));
                    ...
                    map<string, vector<string> >& mapMultiSettingsRet)
{
    ...
    if (!streamConfig.good())
        return; // No quadcoin.conf file is OK
    ...
    {
        // Don't overwrite existing settings so command line settings override quadcoin.conf
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "quadcoin.pid"));
