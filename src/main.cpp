...
uint256 hashGenesisBlock("0x2346a0f6a7f837d6354450fa964031734abb6a683eec4d286e01b6f43e006cb5");
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal quadcoin miner
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xddbfa794b2ee19a986e2069dd831963b15fdbf5123b04eedb836d6d9194b5787");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Saturday October 25, 2014";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1414265955; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 3605714;

        if (fTestNet)
        {
            block.nTime    = 1414262422;
            block.nNonce   = 2750911;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x85f0819365758e724b12018036b66077a64659b0b31634c9a1e9efde4632fb83"));
